...
def test_load_line_annotated_manga_dataset():
    ...
    dataset = LocalizationDataset.load_line_annotated_manga_dataset(dataset_dir, batch_image_size=Size.of(400, 500))
...
def test_load_generated_manga_dataset():
    ...
    dataset = LocalizationDataset.load_generated_manga_dataset(dataset_dir, batch_image_size=Size.of(500, 500))
...
def test_load_generated_manga_dataset_with_resize(tmpdir):
    ...
    dataset = LocalizationDataset.load_generated_manga_dataset(dataset_dir, batch_image_size=Size.of(200, 200))
...
def test_merge_dataset_with_different_batch_size():
    dataset_annotated = LocalizationDataset.load_line_annotated_manga_dataset(
